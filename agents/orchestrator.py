...
def _invoke_text(prompt: str, stream_to_ui: bool = False) -> str:
...
def validate_intent(state: AgentState) -> AgentState:
    ...
    try:
        intent = _parse_json(_invoke_text(prompt))
...
def technical_agent(state: AgentState) -> AgentState:
    ...
    return {"technical_analysis": _invoke_text(prompt)}
...
def fundamental_agent(state: AgentState) -> AgentState:
    ...
    return {"fundamental_analysis": _invoke_text(prompt)}
...
def news_agent(state: AgentState) -> AgentState:
    ...
    return {"news_analysis": _invoke_text(prompt)}
...
def summarizer_agent(state: AgentState) -> AgentState:
    ...
    next_state = {**state, "language": language, "analysis": _invoke_text(prompt, stream_to_ui=True)}
    return {
...
def follow_up_agent(state: AgentState) -> AgentState:
    ...
    return {
        ...
        "analysis": _invoke_text(prompt, stream_to_ui=True),
        "cached_analysis": cached_analysis,
    }
